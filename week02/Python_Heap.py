# -*- coding: utf-8 -*-
"""
# @file name  : Python_Heap.py
# @author     : Ares
# @date       : 2020-07-19
# @brief      : Pythonic way to create a Heap
                Actually, a Heap is a PriorityQueue
"""
...
class Heap_Pri_Queue(object):
    def __init__(self, elems):
        '''
        :param elems: []
        i结点的父结点位置为(i-1)//2(取整)，i结点的左右子结点位置为2*i+1和2*i+2。
        '''
